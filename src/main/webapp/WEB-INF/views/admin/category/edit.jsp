...
<c:url var="editCategoryURL" value="/quan-tri/chuyen-muc/chinh-sua" />
							...
							<form:form class="form-horizontal" role="form" id="formSubmit"
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1">Tên mã chuyên mục:</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1">Tên chuyên mục</label>
									<div class="col-sm-9">
									...
									<div class="col-md-offset-3 col-md-9">
										<c:if test="${not empty model.id}">
											<button class="btn btn-info" type="button"
												...
												<i class="ace-icon fa fa-check bigger-110"></i> Cập nhật chuyên mục
											</button>
										</c:if>
										<c:if test="${empty model.id}">
											<button class="btn btn-info" type="button"
												id="btnAddOrUpdateCategory">
												<i class="ace-icon fa fa-check bigger-110"></i> Thêm chuyên mục
											</button>
										</c:if>
		...
		<script>
			...
			function updateCategory(data) {
				$.ajax({
					...
					dataType : 'json',
					success : function(result) {
						window.location.href = "${editCategoryURL}?id=" + result.id
