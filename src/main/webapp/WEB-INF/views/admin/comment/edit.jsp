						...
						<div class="col-xs-12">
							...
							<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
								<div class="form-group">
									<label for="userName"
										class="col-sm-3 control-label no-padding-right">Người dùng:</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									<label for="title"
										class="col-sm-3 control-label no-padding-right">Bài viết:</label>
									<div class="col-sm-9">
										<form:select path="title" id="title">
											<form:option value="" label="-- Chọn bài viết --" />
									...
									<div class="col-md-offset-3 col-md-9">
										<c:if test="${not empty model.id}">
											<button class="btn btn-info" type="button"
												id="btnAddOrUpdateComment">
												<i class="ace-icon fa fa-check bigger-110"></i> Cập nhật bình luận
											</button>
										</c:if>
										<c:if test="${empty model.id}">
											<button class="btn btn-info" type="button"
												id="btnAddOrUpdateComment">
												<i class="ace-icon fa fa-check bigger-110"></i> Thêm bình luận
											</button>
										</c:if>
		...
		<script>
				...
				$
						.ajax({
							...
							success : function(result) {
								window.location.href = "${editCommentURL}?id="
			...
			function updateComment(data) {
				$.ajax({
					...
					dataType : 'json',
					success : function(result) {
						window.location.href = "${editCommentURL}?id=" + result.id
