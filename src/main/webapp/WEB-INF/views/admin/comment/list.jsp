									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createCommentURL"
													value="/quan-tri/binh-luan/chinh-sua" />
												<a flag="info"
													class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
													data-toggle="tooltip" title='Thêm bình luận'
													href='${createCommentURL}'> <span> <i
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>${item.userName}</td>
															<td>${item.content}</td>
															<td><c:url var="updateCommentURL"
																	value="/quan-tri/binh-luan/chinh-sua">
																	<c:param name="id" value="${item.id}" />
																</c:url> <a class="btn btn-sm btn-primary btn-edit"
																data-toggle="tooltip" title="Cập nhật bình luận"
																href='${updateCommentURL}'><i
