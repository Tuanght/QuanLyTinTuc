							...
							<form:form class="form-horizontal" role="form" id="formSubmit"
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1">Tên mã vai trò:</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1">Tên vai trò</label>
									<div class="col-sm-9">
		...
		<script>
				...
				$
						.ajax({
							...
							success : function(result) {
								window.location.href = "${editRoleURL}?id="
			...
			function updateRole(data) {
				$.ajax({
					...
					dataType : 'json',
					success : function(result) {
						window.location.href = "${editRoleURL}?id=" + result.id
