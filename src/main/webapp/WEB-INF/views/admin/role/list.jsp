									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createRoleURL"
													value="/quan-tri/vai-tro/chinh-sua" />
												<a flag="info"
													class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
													data-toggle="tooltip" title='Thêm vai trò'
													href='${createRoleURL}'> <span> <i
												...
												<button id="btnDelete" type="button"
													...
													data-toggle="tooltip" title='Xóa vai trò'>
													...
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															<td><input type="checkbox" id="checkbox_${item.id}"
																value="${item.id}"></td>
															<td>${item.name}</td>
															<td><c:url var="updateRoleURL"
																	value="/quan-tri/vai-tro/chinh-sua">
																	<c:param name="id" value="${item.id}" />
																</c:url> <a class="btn btn-sm btn-primary btn-edit"
																data-toggle="tooltip" title="Cập nhật vai trò"
																href='${updateRoleURL}'><i
